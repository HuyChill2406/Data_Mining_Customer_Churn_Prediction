...
Bài toán phân loại theo phong cách Kaggle: xây dựng pipeline EDA → Tiền xử lý → Huấn luyện → Đánh giá → Submission với nhiều mô hình (Decision Tree, RandomForest, XGBoost/LightGBM/CatBoost).
